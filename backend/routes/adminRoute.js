...
router.post("/update-admin-profile", (req, res) => {
  adminHelper.updateAdminDetails(req.body).then((resp) => {
    res.status(200).json(resp);
  });
});

router.get("/all-booking-details", (req, res) => {
  adminHelper
    .getAllBookedDetails()
    .then((resp) => {
      res.status(200).json(resp);
